-- BATCH 1: THE SUPREME HUBS (ENHANCED ELITE VOLUME)
-- Migrating: Kedarnath, Somnath, Kashi Vishwanath, Mahakaleshwar, Dwarka, Puri, Rameswaram, Vaishno Devi

-- 1. CLEANUP LEGACY ENTRIES
DELETE FROM "public"."destinations" WHERE slug IN (
    'kedarnath', 'somnath', 'kashi-vishwanath', 'varanasi', 'mahakaleshwar', 'ujjain',
    'dwarka', 'puri', 'rameshwaram', 'rameswaram', 'rameswaram-jyotirlinga', 'rameswaram-shakti',
    'vaishno-devi'
);

-- 2. KEDARNATH (The Celestial Peak)
INSERT INTO "public"."destinations" (
    "id", "name", "slug", "type", "state_id", "description", "x", "y", "size", "images", "is_featured", "is_active", "tagline", "seo_title", "seo_description", "seo_keywords", "order_rank", "content"
) VALUES (
    gen_random_uuid(), 
    'Kedarnath', 
    'kedarnath', 
...
-- 3. SOMNATH (The Eternal Resilience)
INSERT INTO "public"."destinations" (
    "id", "name", "slug", "type", "state_id", "description", "x", "y", "size", "images", "is_featured", "is_active", "tagline", "seo_title", "seo_description", "seo_keywords", "order_rank", "content"
) VALUES (
    gen_random_uuid(), 
...
-- 4. KASHI VISHWANATH (The Golden Gateway)
INSERT INTO "public"."destinations" (
    "id", "name", "slug", "type", "state_id", "description", "x", "y", "size", "images", "is_featured", "is_active", "tagline", "seo_title", "seo_description", "seo_keywords", "order_rank", "content"
) VALUES (
    gen_random_uuid(), 
...
-- 5. MAHAKALESHWAR (The Master of Time)
INSERT INTO "public"."destinations" (
    "id", "name", "slug", "type", "state_id", "description", "x", "y", "size", "images", "is_featured", "is_active", "tagline", "seo_title", "seo_description", "seo_keywords", "order_rank", "content"
) VALUES (
    gen_random_uuid(), 
...
-- 8. RAMESWARAM (The Sacred Bridge)
INSERT INTO "public"."destinations" (
    "id", "name", "slug", "type", "state_id", "description", "x", "y", "size", "images", "is_featured", "is_active", "tagline", "seo_title", "seo_description", "seo_keywords", "order_rank", "content"
) VALUES (
    gen_random_uuid(), 
...
-- 9. VAISHNO DEVI (The Divine Calling)
INSERT INTO "public"."destinations" (
    "id", "name", "slug", "type", "state_id", "description", "x", "y", "size", "images", "is_featured", "is_active", "tagline", "seo_title", "seo_description", "seo_keywords", "order_rank", "content"
) VALUES (
    gen_random_uuid(), 
