...
console.log(`Total Poojas Found in SQL Dump: ${activeCount + disabledCount}`);
console.log(`- Active Poojas (Migrated): ${activeCount}`);
console.log(`- Disabled/Hidden Poojas (Skipped): ${disabledCount}`);
